...
void main() {
  ...
  group('Adventure Feature Unit & Widget Tests', () {
    testWidgets('ActionOptionsPanel renders choices and handles tap', (tester) async {
      String? selected;
    ...
    testWidgets('AdventureWizardScreen renders stepper and advances steps', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            theme: AppTheme.light(),
    ...
    testWidgets('AdventureWizardScreen Step 1 renders AI worldview panel and creation buttons', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            theme: AppTheme.light(),
    ...
    testWidgets('AdventureWizardScreen Step 2 allows adding character with role and relation', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            theme: AppTheme.light(),
    ...
    testWidgets('AdventureWizardScreen Step 2 renders associated characters and relation selectors when characters exist', (tester) async {
    ...
    testWidgets('AdventureWizardScreen Step 3 renders AI prologue generation panel and action branch fields', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            theme: AppTheme.light(),
    ...
    testWidgets('AdventureWizardScreen renders header and close button', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            theme: AppTheme.light(),
    ...
    testWidgets('AdventureSessionScreen renders blank slate empty state and input bar', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            theme: AppTheme.light(),
    ...
    testWidgets('DashboardCharacterCards renders section title and icon', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            theme: AppTheme.light(),
    ...
    testWidgets('PromptSettingsScreen renders dialogue level and prompt sections', (tester) async {

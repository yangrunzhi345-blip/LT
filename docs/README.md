...
| **03** | [03_PHASE_MODELS_ENGINES.md](./03_PHASE_MODELS_ENGINES.md) | **领域契约模型与业务引擎** | 场景对话双段协议契约、角色/世界观/预设模型、`ChatEngine` 状态机、`PromptBuilder`、`StreamHandler`、`LLMService` | 完整的 LLM 对话链路、上下文滑动窗口与打字机流式处理内核 | ✅ **已完成** |
